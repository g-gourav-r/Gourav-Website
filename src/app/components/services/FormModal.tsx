    ...
    <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
      <DialogTrigger asChild>
        <Button
          ...
          size="lg"
          className={cn(
            "mx-auto sm:text-sm  h-12 border bg-neon-yellow/50 hover:text-black text-white hover:bg-neon-yellow  border-neon-yellow  text-xs flex justify-center items-center rounded-2xl hover:shadow-lg transition duration-200 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]",
            buttonClassName
          )}
        >
          {buttonText || "Let's Get Online"}
        </Button>
      </DialogTrigger>
      {isModalOpen && (
